...
\caption{Optimality rate (\%): fraction reaching the exact SAT optimum.
         Parenthesized counts are targets evaluated; the $N{=}4$ column is a
         $\NfourEval$-target subset of the full sweep, and $\dagger$ rates
         ($N{=}4$, $N{=}6$) are over evaluated targets, not the whole sweep.}
\label{tab:main}
...
Daggers ($\dagger$) mark rates over the evaluated subset of the $N{=}4$ and
$N{=}6$ sweeps.
